...
namespace DrasticMedia
{
    ...
    public partial class DrasticSlider : Slider
    {
        ...
        /// Position Changed.
        /// </summary>
        public event EventHandler<DrasticMedia.Core.DrasticSliderPositionChangedEventArgs>? NewPositionRequested;
        ...
        private void DrasticSlider_DragCompleted(object? sender, EventArgs e)
        {
            ...
            this.NewPositionRequested?.Invoke(this, new Core.DrasticSliderPositionChangedEventArgs((float)this.Value));
        }
    }
}
