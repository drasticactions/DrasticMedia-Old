// <copyright file="PlatformSettings.cs" company="Drastic Actions">
...
namespace DrasticMedia.Core.Platform
{
    ...
    {
        /// <inheritdoc/>
        public string MetadataPath => Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData), "DrasticMediaLibrary");
